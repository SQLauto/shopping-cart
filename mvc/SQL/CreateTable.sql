...
insert into Categories (Title, ImageUrl) values ('CPUs', '~/Images/CategoryCPUs.png');
set @categoryID = SCOPE_IDENTITY();

insert into Products (CategoryID, Title, ShortDescription, LongDescription, ImageUrl, Price)
values 
(@categoryID, 
 'R7', 
...
-- Memory category
insert into Categories (Title, ImageUrl) values ('Memory', '~/Images/CategoryMemory.png');
set @categoryID = SCOPE_IDENTITY();
...
insert into Categories (Title, ImageUrl) values ('Graphics Cards', '~/Images/CategoryGraphicsCards.png');
set @categoryID = SCOPE_IDENTITY();
